"""
Django settings for leica_assignment project.
...
SECRET_KEY = 'django-insecure-m33c4id1^1i0hq*flf4i$$+hi%n)cw^jqq-v7p56nn@um331tl'
...
ROOT_URLCONF = 'leica_assignment.urls'
...
WSGI_APPLICATION = 'leica_assignment.wsgi.application'
